...
const services = [
    {
        ...
        description: 'Custom machine learning models and AI solutions that drive measurable business outcomes and competitive advantage.',
        link: '/services#ai-ml',
    },
    {
        icon: (
    ...
    },
    {
        ...
        title: 'Generative AI',
        description: 'Harness the power of GenAI with enterprise-ready solutions, from strategy to production deployment.',
        link: '/services#genai',
    },
    {
        icon: (
    ...
    },
    {
        ...
        link: '/services#decision-intelligence',
    },
];
